...
const Signup = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      const res = await axios.post("http://localhost:5000/api/auth/signup/send-otp", {
        name: form.name,
        email: form.email,
        ...
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-base text-slate-300 max-w-md leading-relaxed">
              Enterprise-grade streaming infrastructure for everyone. High
              availability, low latency, and zero compromises.
            </p>
          ...
          >
            <div className="bg-[#021019]/90 backdrop-blur-xl border border-slate-700/50 rounded-xl p-6 lg:p-8 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-4">
                  ...
                  {[
                    ...
                    >
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-lg bg-[#001E2B] border ${
                          error && !form[field.name]
                            ? "border-red-500/50 focus:border-red-500"
                            : "border-slate-600 focus:border-[#00ED64]"
                        } text-white focus:ring-1 focus:ring-[#00ED64] transition-all outline-none text-sm placeholder:text-slate-500`}
                      />
                    </motion.div>
                  ))}
                </div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-lg bg-[#001E2B] border ${
                          ...
                          (!form[field.name] ||
                            ...
                            ? "border-red-500/50 focus:border-red-500"
                            : "border-slate-600 focus:border-[#00ED64]"
                        } text-white focus:ring-1 focus:ring-[#00ED64] transition-all outline-none text-sm placeholder:text-slate-500 pr-10`}
                      />
                      <button
                        type="button"
                ...
                <motion.p
                  variants={itemVariants}
                  className="text-[10px] text-slate-500 text-center leading-relaxed px-4 pt-2"
                >
                  By joining, you agree to our{" "}
                  <span className="text-slate-400 hover:text-[#00ED64] cursor-pointer underline">
                    Terms
                  </span>{" "}
                  and{" "}
                  <span className="text-slate-400 hover:text-[#00ED64] cursor-pointer underline">
